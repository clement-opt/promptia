...
export default function ResetModal({ onConfirm, onCancel }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative glass rounded-2xl shadow-2xl w-full max-w-sm p-6 text-center">
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 border border-opt-border rounded-xl py-2.5 text-sm
